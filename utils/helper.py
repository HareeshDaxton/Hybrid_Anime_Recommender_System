...
def getAnimeFeame(anime, path_df):
    ...
    if anime_list:
            ...
            for i,anime_name in enumerate(sorted_list.index):
                ...
                if isinstance(anime_name,str):
                    frame = getAnimeFeame(anime_name,df)
